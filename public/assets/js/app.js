...
$(document).ready(function() {
	...
	$(add_button).click(function(e){ //on add input button click
		...
		if(x < max_fields){ //max input box allowed
			...
			$(wrapper).append('<div class="row py-1"> <div class="col-xl-9 col-md-9 text-md-start"><input type="text" value="Type" class="form-control border-bottom"></div><div class="col-xl-3 col-md-3 text-md-end"><input type="number" value="0" class="form-control  text-md-end"></div><a href="#" class="remove_field">Remove</a></div>'); //add input box
		}
	});
	0
...
$(document).ready(function() {
	...
	$(add_button).click(function(e){ //on add input button click
		...
		if(x < max_fields){ //max input box allowed
			x++; //text box increment
			$(wrapper).append('<div class="row py-1"> <div class="col-xl-9 col-md-9 text-md-start"><input type="text" value="Type" class="form-control border-bottom"></div><div class="col-xl-3 col-md-3 text-md-end"><input type="number" value="0" class="form-control  text-md-end"></div><a href="#" class="remove_field1">Remove</a></div>'); //add input box
		}
	});
	0
...
$("#btnSubmit").click(function(){
   ...
   $(document).ready(function(){
        ...
        var fieldHTML = '<div class="mb-3"><input type="text" required name="field_name[]" value=""  style="width: 92%; border-radius: .25rem; padding: 0.47rem 1.75rem 0.47rem 0.75rem; border: 1px solid #ced4da;"/><a href="javascript:void(0);" class="remove_button"><i class="bx bxs-x-circle fs-4"></i></a></div>'; //New input field html 
    ...
    $(document).ready(function(){
        ...
        var fieldHTMLs = '   <tr><td data-priority="1"><select required id="class_id" name="class_id" class="form-control form-select"><option value="" disabled>Select</option><option value="">Biology</option><option value="">Mathematics</option><option value="">French</option><option value="">English</option></select></td><td data-priority="1"><div ><div class="input-group"><div class="input-group-text"><i class="bx bxs-calendar"></i></div><input type="text" class="form-control" id="specificSizeInputGroupUsername"></div></div></td><td data-priority="1"><div ><div class="input-group"><div class="input-group-text"><i class="bx bxs-calendar"></i></div><input type="text" class="form-control" id="specificSizeInputGroupUsername"></div></div></td><td data-priority="1"><input class="form-control" type="text"></td><td data-priority="1"><input class="form-control" type="text"></td><td data-priority="1"><input class="form-control" type="text"></td><td data-priority="1"><input class="form-control" type="text"></td><td data-priority="1"><input class="form-control" type="text"></td><td data-priority="1"><input class="form-control" type="text"></td><td data-priority="1"><i class="bx bx-x remove_buttons"></i></td></tr>'; //New input field html 
        var x = 1; //Initial field counter is 1
