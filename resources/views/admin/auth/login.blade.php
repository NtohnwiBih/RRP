                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="custom-form mt-4 pt-2" action="{{route('authenticate')}}" method="post">
                                    @csrf
                                        <label class="form-label" for="username">{{__("auth.phone_number")}}</label>
                                        <input type="text" class="form-control" id="phone_number" placeholder="{{__("auth.enter_phone_number")}}" name="mobile" value="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" class="form-control" placeholder="{{__("auth.enter_password")}}" name="password" aria-label="Password" aria-describedby="password-addon">
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="">
                                                <a href="#" class="text-muted">{{__("auth.forgot_password")}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">{{__("auth.log_in")}}</button>
                                    </div>
                                </form>
