                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="custom-form mt-4 pt-2 row" action="#" method="post">
                                    @csrf
                                    <input type="text" name="role" value="vendor" hidden/>
                                    <div class="col-md-6">
                                        <label for="inputName" class="form-label">{{__("auth.full_name")}}</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="username" type="text" class="form-control" id="inputUserName" placeholder="Choose a unique username" autocomplete="username" autofocus required value="{{old('username')}}">
                                        <small style="color: #e20000" class="error">{{$errList['username']}}</small>
                                        <small id="username-error"></small>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="inputMobileAddress" class="form-label">{{__("auth.phone_number")}}</label>
                                        <input name="mobile" type="text" class="form-control" id="inputMobileAddress"  autocomplete="username" required placeholder="{{__('auth.enter_phone_number')}}" value="{{old('mobile')}}">
                                        <small style="color: #e20000" class="error">{{$errList['mobile']}}</small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="inputChoosePassword" class="form-label">{{__("auth.password")}}</label>
                                        <div class="input-group" id="show_hide_password">
                                            <input name="password" type="password" class="form-control border-end-0" autocomplete="new-password" required id="inputChoosePassword" placeholder="{{__('auth.enter_password')}}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group" id="show_hide_password">
                                            <input name="password_confirmation" type="password" class="form-control border-end-0" autocomplete="new-password" required id="inputChoosePassword" placeholder="{{__('auth.enter_password')}}">
                                            <button class="btn btn-light ms-0" type="button" id="confirm-password-addon"><i class="mdi mdi-eye-outline"></i></button>
                                        </div>
                                            <small style="color: #e20000" class="error"></small>
                                    </div>
                                    <div class="mb-3">
...
@push('scripts')
<script>
    // app.js (or any other JavaScript file)
