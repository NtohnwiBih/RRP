            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('room.update', $room->id) }}"  method="post" enctype="multipart/form-data" id="room-form">
                       ...
                       @method('PUT')
                       <div class="row">
                            <input name="propertyid" value="{{$room->property->id}}" hidden>
                            <input type="text" name="houseid" value="{{$room->house->id}}" class="form-control" hidden>
                            <input type="text" name="roomid" value="{{$room->id}}" class="form-control" hidden>
                            <input type="text" name="type" value="{{$room->type}}" class="form-control" hidden>
                            <input type="text" name="house-type" value="{{$room->house->type}}" class="form-control" hidden>
                            <div class="col-xl-6">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="formrow-firstname-input">Name</label>
                                    <input type="text" name="name" class="form-control" value="{{$room->property->name}}">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-group mb-3">
                            ...
                            <div class="col-xl-4">
                               <div class="form-group mb-3">
                                    ...
                                    @if($room->property->region_id == 1)
                                    <option selected value="{{$room->property->region_id}}">Adamawa</option>
                                    @elseif($room->property->region_id == 2)
                                    <option selected value="{{$room->property->region_id}}">Centre</option>
                                    @elseif($room->property->region_id == 3)
                                    <option selected value="{{$room->property->region_id}}">East</option>
                                    @elseif($room->property->region_id == 4)
                                    <option selected value="{{$room->property->region_id}}">Far North</option>
                                    @elseif($room->property->region_id == 5)
                                    <option selected value="{{$room->property->region_id}}">Littoral</option>
                                    @elseif($room->property->region_id == 6)
                                    <option selected value="{{$room->property->region_id}}">North</option>
                                    @elseif($room->property->region_id == 7)
                                    <option selected value="{{$room->property->region_id}}">North West</option>
                                    @elseif($room->property->region_id == 8)
                                    <option selected value="{{$room->property->region_id}}">South</option>
                                    @elseif($room->property->region_id == 9)
                                    <option selected value="{{$room->property->region_id}}">South West</option>
                                    @elseif($room->property->region_id == 10)
                                    <option selected value="{{$room->property->region_id}}">West</option>
                                    @endif
                            ...
                            <div class="col-xl-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="city" class="form-control" value="{{$room->property->city}}">
                                </div>
                            </div>
                            <div class="col-xl-4">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="formrow-firstname-input">Quater</label>
                                    <input type="text" name="quater" class="form-control" value="{{$room->property->quater}}">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="formrow-firstname-input">Description</label>
                                    <textarea class="form-control" name="description" id="ckeditor-classic">{{$room->property->description}}</textarea>
                                </div>
                            </div>
                            <div class="col-xl-6">
                               <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="bathroom">
                                        <option selected>{{$room->bathroom}}</option>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="price" class="form-control" value="{{$room->property->amount}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 mb-3">
                                <div class="forn-group control">
                                    ...
                                    <div class="content">
                                        <div class="row">
                                                @foreach (json_decode($room->property->image) as $image)
                                                <div class="col-md-3 mb-3"><img src="/uploads/images/property/house/room/{{$image}}" class="img-fluid" /></div>
                                                @endforeach
                                        </div>
                                    </div>
