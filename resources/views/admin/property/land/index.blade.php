                                    ...
                                    <tr>
                                        ...
                                        <td data-priority="1" class="text-end">
                                            <form action="{{ route('land.destroy',$land->id) }}" method="Post">
                                                <a class="btn btn-success" href="" data-toggle="modal" data-target="#exampleModalCenter"> <i class='bx bxs-show'></i></a>
                                        ...
                                        <div class="app-card-actions">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('land.edit',$land->id) }}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
